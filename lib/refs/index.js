var pathUtils             = require('../path')
  ...
  , createRefEmitter      = refUtils.createRefEmitter
...
, proto: {
    ...
    _getRef: function (path) {
      ...
      return this._memory.get(path, this._memory._data, true);
    }
